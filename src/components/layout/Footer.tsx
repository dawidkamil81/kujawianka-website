...
import { Facebook, Instagram, Mail, MapPin, Phone, ArrowRight, Shield, Youtube } from "lucide-react";
import { urlFor } from "@/sanity/lib/image";
import type { SiteSettings } from "@/types";

// --- CUSTOMOWE IKONY ---

// 1. TikTok (brak w starszych wersjach Lucide)
...
const XIcon = ({ className }: { className?: string }) => (
    <svg
        ...
        fill="currentColor"
        className={className}
        width="22" height="22" // Domyślny rozmiar dopasowany do reszty
    >
...
export default function Footer({ settings }: FooterProps) {
    ...
    // Konfiguracja social mediów z kolorami i ikonami
    const socials = [
        {
            key: 'facebook',
            label: 'Facebook',
        ...
        },
        {
            ...
            icon: XIcon, // <--- Używamy nowego komponentu
            hoverClass: 'hover:bg-black hover:border-white/20 hover:shadow-[0_4px_20px_-5px_rgba(255,255,255,0.2)]'
        }
    ];
                ...
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-4 lg:gap-8">
                    ...
                    <div className="flex flex-col items-center lg:items-start">
                        ...
                        <div className="flex gap-4 flex-wrap justify-center lg:justify-start">
                            {socials.map((social) => {
                                // Wyciągamy dane do zmiennej lokalnej
                                const linkData = social.data;

                                // Type Guard: Sprawdzamy czy obiekt i pola istnieją
                                ...
                                return (
                                    <a
                                        ...
                                        className={`group flex h-12 w-12 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-white transition-all duration-300 hover:-translate-y-1 ${social.hoverClass}`}
                                    >
