...
export default function PlayerCard({ player }: PlayerCardProps) {
    ...
    return (
        <div
            // 1. KONTENER GŁÓWNY
            // [perspective:1000px] - kluczowe dla efektu 3D na wszystkich przeglądarkach
        ...
        >
            ...
            >
                {/* === PRZÓD KARTY === */}
                {/* PRZENIESIONO STYLE: rounded-xl, overflow-hidden, border, bg - są teraz bezpośrednio tutaj */}
                <div className={`
                    absolute inset-0 w-full h-full 
                    [backface-visibility:hidden] [transform:rotateY(0deg)] [webkit-backface-visibility:hidden] 
                    rounded-xl overflow-hidden border border-white/5 bg-[#121212] 
                ...
                {/* === TYŁ KARTY === */}
                {/* PRZENIESIONO STYLE: rounded-xl, overflow-hidden, bg, border - bezpośrednio tutaj */}
                <div className={`
                    absolute inset-0 w-full h-full 
                    [backface-visibility:hidden] [transform:rotateY(180deg)] [webkit-backface-visibility:hidden] 
                    rounded-xl overflow-hidden bg-[#141414] border border-club-green/40 shadow-2xl 
                    flex flex-col p-5
                `}>
