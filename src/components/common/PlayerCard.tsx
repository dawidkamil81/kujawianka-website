...
export default function PlayerCard({ player }: PlayerCardProps) {
    ...
    return (
        <div
            // 1. KONTENER GŁÓWNY
            // group - do hovera
            // perspective - niezbędne do efektu 3D
        ...
        >
            {/* 2. ELEMENT OBRACAJĄCY SIĘ (FLIPPER) */}
            <div
                className={`
            ...
            >
                {/* === PRZÓD KARTY === */}
                {/* Kluczowe dla Safari: [transform:rotateY(0deg)] i [backface-visibility:hidden] */}
                <div className="absolute inset-0 w-full h-full [backface-visibility:hidden] [transform:rotateY(0deg)] [webkit-backface-visibility:hidden]">
                ...
                {/* === TYŁ KARTY === */}
                {/* Kluczowe dla Safari: [transform:rotateY(180deg)] - statycznie obrócony tył */}
                <div className="absolute inset-0 w-full h-full [backface-visibility:hidden] [transform:rotateY(180deg)] [webkit-backface-visibility:hidden] bg-[#141414] rounded-xl overflow-hidden">
                    <div className="relative h-full w-full border border-club-green/40 shadow-2xl flex flex-col p-5">
