...
export default function PlayerCard({ player }: PlayerCardProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative h-full w-full transition-all duration-500 [transform-style:preserve-3d] ${isFlipped ? '[transform:rotateY(180deg)]' : '[transform:rotateY(0deg)]'} `}
      >
        {/* === PRZÓD KARTY === */}
        ...
        >
          ...
          {/* Statystyki */}
          <div className="scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent flex flex-1 flex-col gap-1 overflow-y-auto">
