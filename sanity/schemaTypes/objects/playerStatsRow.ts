...
export const playerStatsRow = defineType({
    ...
    fields: [
        ...
        defineField({ name: 'minutes', title: 'Minuty', type: 'number', initialValue: 90 }),
        defineField({ name: 'goals', title: 'Gole', type: 'number', initialValue: 0 }),
        defineField({ name: 'assists', title: 'Asysty', type: 'number', initialValue: 0 }),
        defineField({ name: 'yellowCards', title: 'Żółte kartki', type: 'number', initialValue: 0 }),
        defineField({ name: 'redCard', title: 'Czerwona kartka', type: 'boolean', initialValue: false }),
        defineField({ name: 'cleanSheet', title: 'Czyste konto', type: 'boolean', initialValue: false }),
    ],
    preview: {
        select: {
