            ...
            of: [
                {
                    ...
                    fields: [
                        ...
                        defineField({ name: 'description', title: 'Opis kroku', type: 'text', rows: 2 }),
                    ]
                }
            ],
            validation: (rule) => rule.length(3).error('Musisz dodać dokładnie 3 kroki, aby pasowały do układu strony.')
        }),
        ...
        defineField({
            ...
            fields: [
                ...
                defineField({
                    ...
                    type: 'text',
                    rows: 3,
                    initialValue: 'Twoje 1.5% to realne wsparcie dla tych dzieciaków. Budujemy razem coś więcej niż klub.'
                }),
                defineField({
                    name: 'author',
                    title: 'Podpis (Autor)',
