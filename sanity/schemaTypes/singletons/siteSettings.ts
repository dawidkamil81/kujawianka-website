...
export const siteSettings = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      description:
        'Główny tytuł strony (np. nazwa klubu), widoczny na pasku przeglądarki.',
    ...
    defineField({
      ...
      description:
        'Zarządzaj linkami do social mediów. Włącz "Widoczny", aby ikona pojawiła się w stopce.',
      fields: [
    ...
    defineField({
      ...
      description:
        'Logotyp partnera, certyfikat lub licencja (widoczny obok logo w stopce)',
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          type: 'image',
          description:
            'Obrazek, który pojawi się po wklejeniu linku do strony na Facebooka.',
        }),
      ],
    }),
  ],
